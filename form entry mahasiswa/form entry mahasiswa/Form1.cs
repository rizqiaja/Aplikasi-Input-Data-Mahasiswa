...
namespace form_entry_mahasiswa
{
    public partial class Form1 : Form
    {
        ...
        private void InisialisasiListView()
        {
            ...
            lvwMahasiswa.Columns.Add("Name", 150, HorizontalAlignment.Left);
            lvwMahasiswa.Columns.Add("Jenis Kelamin", 90, HorizontalAlignment.Left);
            lvwMahasiswa.Columns.Add("Tempat Lahir", 150, HorizontalAlignment.Left);
            lvwMahasiswa.Columns.Add("Tanggal Lahir", 90, HorizontalAlignment.Left);
            lvwMahasiswa.Columns.Add("Alamat", 200, HorizontalAlignment.Left);
        }

        private void InisialisasiDataDummy()
        {
            listOfMahasiswa.Add(new Mahasiswa { Nim = "17.11.0932", Name = "Irnesia Anggela P S", Gender = "Perempuan", Born = "Solo", Date = "03/11/1998", Alamat = "Solo" });
            listOfMahasiswa.Add(new Mahasiswa { Nim = "17.11.0933", Name = "Nur Rachmat Dedi S", Gender = "Laki-laki", Born = "Sleman", Date = "12/04/1997", Alamat = "Sleman" });
            listOfMahasiswa.Add(new Mahasiswa { Nim = "17.11.0934", Name = "Septiana Puspa Anggraeni", Gender = "Perempuan", Born = "Manado", Date = "09/09/1997", Alamat = "Manado" });
            listOfMahasiswa.Add(new Mahasiswa { Nim = "17.11.0935", Name = "Aziza Devita Indraswari", Gender = "Perempuan", Born = "Bantul", Date = "06/12/1997", Alamat = "Bantul" });
